...
RES = COM[0].split()[3]
# for acpype and original gromacs format
ITP = [[x for x in line.split()] for line in open(sys.argv[1], 'r') if RES in line and 'qtot' in line]
